 ...
 */
export const storyProtocolGatewayAbi = [
  {
    type: "constructor",
    inputs: [
      { name: "accessController", internalType: "address", type: "address" },
  ...
  {
    type: "function",
    inputs: [{ name: "ipCollection", internalType: "address", type: "address" }],
 ...
 * [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xf82EEe73c2c81D14DF9bC29DC154dD3c079d80a0)
 */
export const storyProtocolGatewayAddress = {
 ...
 * [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xf82EEe73c2c81D14DF9bC29DC154dD3c079d80a0)
 */
export const storyProtocolGatewayConfig = {
  address: storyProtocolGatewayAddress,
  abi: storyProtocolGatewayAbi,
} as const;
...
// Contract StoryProtocolGateway =============================================================

/**
 * StoryProtocolGatewayCreateIpCollectionRequest
 *
 * @param collectionType uint8
 * @param collectionSettings tuple
 * @param mintSettings tuple
 */
export type StoryProtocolGatewayCreateIpCollectionRequest = {
...
/**
 * StoryProtocolGatewayMintAndRegisterIpWithSigRequest
 *
 * @param policyId uint256
 * @param tokenContract address
 * @param tokenMetadata bytes
 * @param ipMetadata tuple
 * @param signature tuple
 */
export type StoryProtocolGatewayMintAndRegisterIpWithSigRequest = {
  policyId: bigint;
  tokenContract: Address;
  tokenMetadata: Hex;
  ipMetadata: {
...
/**
 * contract StoryProtocolGateway write method
 */
export class StoryProtocolGatewayClient {
  protected readonly wallet: SimpleWalletClient;
  protected readonly rpcClient: PublicClient;
  public readonly address: Address;

  constructor(rpcClient: PublicClient, wallet: SimpleWalletClient, address?: Address) {
    this.address = address || getAddress(storyProtocolGatewayAddress, rpcClient.chain?.id);
    this.rpcClient = rpcClient;
    this.wallet = wallet;
  }
  ...
  public async createIpCollection(
    request: StoryProtocolGatewayCreateIpCollectionRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: storyProtocolGatewayAbi,
      address: this.address,
      functionName: "createIpCollection",
      account: this.wallet.account,
      args: [request.collectionType, request.collectionSettings, request.mintSettings],
    });
    return await this.wallet.writeContract(call as WriteContractParameters);
  }
  ...
  public async mintAndRegisterIpWithSig(
    request: StoryProtocolGatewayMintAndRegisterIpWithSigRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: storyProtocolGatewayAbi,
      address: this.address,
      functionName: "mintAndRegisterIpWithSig",
      account: this.wallet.account,
      args: [
        request.policyId,
